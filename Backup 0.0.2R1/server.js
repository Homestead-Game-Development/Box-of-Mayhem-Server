               ...
               switch(d.state) {
                  ...
                  case "chat":
                     if(userdata.authenticated) {
                        _server.broadcastMessage(userdata.username+": "+d.msg);
                     }
                  break;
                  ...
                  case "RequestInitialTextureHash":
                  ...
                  case "RequestCacheFile":
                     ...
                     console.log("Sending image to " + userdata.username);

                     reply(ws, "ReceiveCacheImage", {img:img});
                  break;

                  case "RequestBlockData":
